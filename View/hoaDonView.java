...
public class hoaDonView extends JFrame {
	...
	public hoaDonView() {
		...
		btnThemDichVu.setBounds(492, 140, 152, 40);
		...
		btnLuuHoaDon.setBounds(745, 505, 119, 34);
		...
		btnXoaDichVu.setBounds(694, 138, 152, 40);
