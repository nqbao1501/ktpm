...
import MVC.View.hoaDonViewBacSi;
import javax.swing.*;
import java.sql.*;
import javax.swing.table.DefaultTableModel;

public class hoaDonControllerBacSi {
    private Connection connection;
    private hoaDonViewBacSi view;

    // Constructor
    public hoaDonControllerBacSi(hoaDonViewBacSi view) throws SQLException, ClassNotFoundException {
        this.view = view;
    ...
    public static void main(String[] args) {
        try {
            hoaDonViewBacSi view = new hoaDonViewBacSi();
            new hoaDonControllerBacSi(view);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
