...
import MVC.View.dichVuViewBenhNhan ;

import javax.swing.*;
import java.sql.*;

public class dichVuControllerBenhNhan {
    private Connection connection;
    private dichVuViewBenhNhan view;

    public dichVuControllerBenhNhan(dichVuViewBenhNhan view) throws SQLException, ClassNotFoundException {
        this.view = view;
    ...
    public static void main(String[] args) {
        try {
        	dichVuViewBenhNhan view = new dichVuViewBenhNhan();
            new dichVuControllerBenhNhan(view);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
